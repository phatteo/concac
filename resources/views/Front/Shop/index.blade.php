        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-8 order-2 order-lg-1 product-sidebar-filter">
                    @include('Front.Shop.componets.products-sidebar-filter')
                </div>
                                ...
                                <form >
                                    <div class="select-option">
                                        <select name="sort_by"  onchange="this.form.submit();" id="" class="sorting">
                                            <option {{request('sort_by') == 'lastest' ? 'selected' : ''}} value="latest">Sorting: Latest</option>
                                        ...
                                        <select name="show"  onchange="this.form.submit();" id="" class="sorting">
                                            <option {{request('show') == '3' ? 'selected' : ''}} value="3">Show: 3</option>
                                            <option {{request('show') == '9' ? 'selected' : ''}} vavalue="9">Show: 9</option>
